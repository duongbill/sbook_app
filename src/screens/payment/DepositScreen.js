...
const DepositScreen = ({ navigation }) => {
    ...
    const predefinedAmounts = [
        '50.000đ', '100.000đ', '200.000đ', '500.000đ', '1.000.000đ', '2.000.000đ'
    ];
    ...
    return (
        <View style={[styles.container, { backgroundColor: theme.colors.backgroundSecondary }]}>
            ...
            <View style={styles.header}>
                ...
                <Text style={[styles.headerText, { color: theme.colors.text }]}>Nạp tiền</Text>
                <View style={{ width: 24 }} />
            </View>
            ...
            <View style={[styles.card, { backgroundColor: theme.colors.background }]}>
                ...
                <View style={styles.amountButtons}>
                    {predefinedAmounts.map((item, index) => (
                        <TouchableOpacity
                            key={index}
                            style={[styles.amountButton, { backgroundColor: theme.colors.border, borderColor: theme.colors.border, color: theme.colors.text }]}
                ...
                <View style={[styles.securityInfo, { backgroundColor: theme.colors.background }]}>
                    <Text style={[styles.securityText, { color: theme.colors.textSecondary }]}>
                        An toàn tài sản & Bảo mật thông tin của bạn là ưu tiên hàng đầu của MoMo.
                    </Text>
                    <TouchableOpacity>
                        <Text style={[styles.link, { color: theme.colors.primary }]}>Tìm hiểu thêm {'>'}</Text>
                    </TouchableOpacity>
                </View>
            </View>
            ...
            <TouchableOpacity
                style={[
                    ...
                    { backgroundColor: amount === '' ? theme.colors.border : theme.colors.primary }
                ]}
                disabled={amount === ''}
            >
